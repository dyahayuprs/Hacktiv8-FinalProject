...
if "messages_history" not in st.session_state:
    ...
    st.session_state["messages_history"] = [
        SystemMessage(
            "You are a travel assistant that knows a lot about Asia. Always response in more than 2 sentences in a chat style. Reply in bahasa indonesia slang words with emotes"
        )
    ]
...
prompt = st.chat_input("Chat about your travel plan...")
if not prompt:
    st.stop()
